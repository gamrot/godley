...
This guide explains how to use the `godley` package to create the LP model — a model with long-term bonds, capital gains and liquidity preference, as described by *Wynne Godley* and *Marc Lavoie* in Chapter 5 of *Monetary Economics. An Integrated Approach to Credit, Money, Income, Production and Wealth.*
...
### References
For more details on LP model, refer to Chapter 5 of *Monetary Economics. An Integrated Approach to Credit, Money, Income, Production and Wealth.*
