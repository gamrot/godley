...
**Note**: Users may skip the manual addition of variables and equations (Steps 2 and 3 below) by loading model attributes from the predefined templates included in the package. The available templates are: `SIM`, `SIMEX`, `PC`, `LP`, `REG`, `OPEN`, `BMW`, `BMWK`, `DIS`, `DISINF`, `INSOUT`, `GROWTH`, and `OPENFIX`.
...
# Plot simulation
plot_simulation(
    model_sen, scenario = "sensitivity", take_all = TRUE,
