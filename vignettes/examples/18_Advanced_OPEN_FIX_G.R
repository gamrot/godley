...
here::i_am("godley/vignettes/examples/17_Advanced_OPEN_FIX_R.R")
...
model_open <- model_open |>
  ...
  add_equation("g_uk = b_uk_s - b_uk_s[-1] -(r_uk[-1]*b_uk_s[-1] - t_uk - f_cb_uk)", desc = "") |>
  # 12.61G: Real government expenditures
  add_equation("g_k_uk = g_uk / pds_uk", desc = "") |>
  # 12.82AG: Supply of UK Bills
  add_equation("b_uk_s = b_usuk_s + b_ukuk_s + b_cb_ukuk_s", desc = "")
...
# Plot results
# Figure 12.3A
do_plot(m = model_open, scenario = "mu0_shock",
