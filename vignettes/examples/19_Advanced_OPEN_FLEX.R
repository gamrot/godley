...
# Figure 12.5B
do_plot(m = model_open, scenario = "eps0_shock", variables = c("xr_uk"))

# Figure 12.5C
do_plot(m = model_open, scenario = "eps0_shock", variables = c("pm_uk", "px_uk", "pds_uk"))

# Figure 12.5D
do_plot(m = model_open, scenario = "eps0_shock", variables = c("y_k_uk", "y_k_us"))
...
# Plot results
# Figure 12.6A
do_plot(m = model_open, scenario = "g_k_us_shock", variables = c("y_k_us", "y_k_uk"))

# Figure 12.6B
do_plot(m = model_open, scenario = "g_k_us_shock", variables = c("nafa_us", "psbr_us", "cab_us"))

# Figure 12.6C
do_plot(m = model_open, scenario = "g_k_us_shock", variables = c("bukus_p", "bukus_d"))

# Figure 12.6D
do_plot(m = model_open, scenario = "g_k_us_shock", variables = c("xr_us"))
...
# Plot results
# Figure 12.7A
do_plot(m = model_open, scenario = "lambda20-40_shock", variables = c("xr_us"))

# Figure 12.7B
do_plot(m = model_open, scenario = "lambda20-40_shock", variables = c("bukus_p", "bukus_d"))

# Figure 12.7C
do_plot(m = model_open, scenario = "lambda20-40_shock", variables = c("y_k_us", "y_k_uk"))

# Figure 12.7D
do_plot(m = model_open, scenario = "lambda20-40_shock", variables = c("psbr_us", "cab_us", "nafa_us", "tab_us"))
