...
here::i_am("godley/vignettes/examples/15_GROWTH2.R")
...
plot_simulation(model = model_growth, scenario = c("GRg_shock"),
                from = 1, to = 150, expressions = c("GRy = (Yk / dplyr::lag(Yk)) - 1"))

# Figure 11.6B
plot_simulation(model = model_growth, scenario = c("GRg_shock"),
                from = 1, to = 150, expressions = c("Rb"))

# Figure 11.6C
do_cplot(m = model_growth, scenario = "GRg_shock",
         from = 1, to = 150, variables = c("Gk", "ER"))

# Figure 11.6A
plot_simulation(model = model_growth, scenario = c("GRg_shock"),
                from = 1, to = 150, expressions = c("Rl", "Rb", "Rm"))
