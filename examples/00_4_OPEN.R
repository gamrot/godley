...
model_OPEN <- prepare(model_OPEN)

## simulation ----

model_OPEN <- simulate(model_OPEN, scenario = 'baseline', max_iter = 350,
                      periods = 100, hidden_tol = 0.1, tol = 1e-08, method = 'Gauss')



plot_series(model = model_OPEN, scenario = 'baseline', from = 1, to = 60,
...
model_OPEN <- simulate(model_OPEN, scenario = 'expansion', max_iter = 350,
                      periods = 60, hidden_tol = 0.1, tol = 1e-08, method = 'Gauss')


plot_series(model = model_OPEN, scenario = 'expansion', from = 1, to = 60,
...
plot_series(model = model_OPEN, scenario = 'expansion', from = 1, to = 60,
            expressions = c('deltaBcb_S = Bcb_S - lag(Bcb_S)',
                            'deltaHs_S = Hs_S - lag(Hs_S)'))
