...
model_LP <- prepare(model_LP)

## simulation ----

model_LP <- simulate(model_LP, scenario = 'baseline', max_iter = 350,
                     periods = 100, hidden_tol = 0.1, tol = 1e-08, method = 'Gauss')



plot_series(model = model_LP, scenario = 'baseline', from = 1, to = 100,
            expressions = c('V'))
